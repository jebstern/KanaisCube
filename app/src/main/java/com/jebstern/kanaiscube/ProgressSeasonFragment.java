...
public class ProgressSeasonFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_progress_season, container, false);

        int cubedArmor = db.getItemAmount("'armor'", "season");
        int cubedWeapons = db.getItemAmount("'weapon'", "season");
        int cubedJewelry = db.getItemAmount("'jewelry'", "season");
        ...
        getActivity().setTitle("Progress - Season");
        return rootView;
    }
